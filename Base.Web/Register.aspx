				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							<form action="Login.aspx" id="smart-form-register" class="smart-form client-form">
								<header>
									Registrar Usuario
								</header>
								...
								<fieldset>
									...
									<section>
										<label class="input">
                                            <i class="icon-append fa fa-lock"></i>
											<input type="password" name="passwordConfirm" placeholder="Confirmar Clave">
											<b class="tooltip tooltip-bottom-right">No olvide su Clave</b>
										</label>
									</section>
								</fieldset>
								...
								<fieldset>
									...
									<div class="row">
										...
										<section class="col col-6">
											<label class="input">
												...
												<input type="text" name="request" placeholder="Requerir la activación el" class="datepicker" data-dateformat='dd/mm/yy' />
											</label>
										</section>
									</div>
									...
									<section>
										<label class="checkbox">
											...
											<i></i>Quiero recibir noticias de actualizaciones
										</label>
										<label class="checkbox">
