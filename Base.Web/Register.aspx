<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SeedProject.Register" %>
...
<body id="login">
    <header id="header">
        ...
        <span id="extr-page-header-space">
            <span class="hidden-mobile hidden-xs">Ya esta registrado?</span>
    ...
    <div id="main" role="main">
        ...
        <div id="content" class="container">
            <div class="row">
                <div id="error-message" class="alert alert-danger fade in" style="visibility:visible">
                    <button class="close" data-dismiss="alert">
                        ×
                    </button>
                    <i class="fa-fw fa fa-times"></i>
                    <strong>Error!</strong> Se presentaron errores|
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    <div class="well no-padding">
                        <form id="smartformregister" class="smart-form client-form" runat="server">
                            <header>
                                Registrar Usuario
                            </header>
                            ...
                            <fieldset>
                                <section>
                                    <label class="input">
                                        ...
                                        <asp:TextBox ID="username" runat="server" placeholder="Usuario"></asp:TextBox>
                                        <b class="tooltip tooltip-bottom-right">Necesario para ingresar al Sitio Web</b>
                                    </label>
                                </section>
                                <section>
                                    <label class="input">
                                        ...
                                        <b class="tooltip tooltip-bottom-right">Necesario para verificar una cuenta</b>
                                    </label>
                                </section>
                                <section>
                                    <label class="input">
                                        <i class="icon-append fa fa-lock"></i>
                                        <asp:TextBox ID="password" runat="server" TextMode="Password" placeholder="Clave"></asp:TextBox>
                                        <b class="tooltip tooltip-bottom-right">No olvide su Clave</b>
                                    </label>
                                </section>
                                <section>
                                    <label class="input">
                                        <i class="icon-append fa fa-lock"></i>
                                        <asp:TextBox ID="passwordConfirm" runat="server" TextMode="Password" placeholder="Confirmar Clave"></asp:TextBox>
                                        <b class="tooltip tooltip-bottom-right">No olvide su Clave</b>
                                    </label>
                                </section>
                            </fieldset>
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-6">
                                        <label class="input">
                                            <asp:TextBox ID="firstname" runat="server" placeholder="Nombres"></asp:TextBox>
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="input">
                                            <asp:TextBox ID="lastname" runat="server" placeholder="Apellidos"></asp:TextBox>
                                        </label>
                                    </section>
                                </div>
                                ...
                                <section>
                                    ...
                                    <label class="checkbox">
                                        ...
                                        <i></i>Acepto los
                                            <a href="#" data-toggle="modal" data-target="#myModal">Terminos y Condiciones</a>
                                    </label>
                                </section>
                            </fieldset>
                            <footer>
                                <asp:Button ID="btnRegistrar" runat="server" Text="Registrar" CssClass="btn btn-primary"
                                    CausesValidation="true" ValidationGroup="approvalgroup" OnClick="Register_Click" OnClientClick="return $('#smartformregister').valid();" />
                    ...
                    <p class="note text-center">*El registro es totalmente necesario para ingresar al sitio.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body custom-scroll terms-body">
                    <div id="left">
                        <h1>PENSEMOS SI TERMINOS Y CONDICIONES DEL SITIO</h1>
                        <h2>Introduccion</h2>
                        ...
                        <h2>Licencia del uso del Sitio Web</h2>
                        ...
                        <h2>Disposiciones no Ejecutables</h2>
                        ...
                        <h2>Incumplimiento de estos terminos y servicios</h2>
                        ...
                        <h2>Sobre los terminos y condiciones del Sitio Web</h2>
                        <p>
                            We created these website terms and conditions with the help of a free website terms and conditions form developed by Contractology and available at <a href="http://www.SmartAdmin.com">www.SmartAdmin.com</a>.
                            Contractology supply a wide variety of commercial legal documents, such as <a href="#">template data protection statements</a>.
                        </p>

                        <h2>Registros y Autorizaciones</h2>
