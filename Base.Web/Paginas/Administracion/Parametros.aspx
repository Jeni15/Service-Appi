<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Sitio.Master" CodeBehind="Parametros.aspx.cs" Inherits="SeedProject.Paginas.Administracion.Parametros" %>
                                                ...
                                                <asp:GridView ID="grvDatos" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table table-striped table-bordered" OnRowCommand="grvDatos_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnEditar" runat="server" CssClass="btn btn-warning btn-xs" CausesValidation="false" CommandName="EditarParametro" CommandArgument='<%#Eval("IDParameter")%>'>
                                                                    <i class="fa fa-pencil"></i>
                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="btnEliminar" runat="server" CssClass="btn btn-danger btn-xs" CausesValidation="false" CommandName="EliminarParametro" CommandArgument='<%#Eval("IDParameter")%>'>
                        ...
                        <article class="col-sm-12 col-md-12">
                            <div class="jarviswidget jarviswidget-color-greenLight" id="wid-id-3" data-widget-editbutton="false">
				                ...
				                <header>
					                ...
					                <h2>Cargue Masivo Parametros</h2>
				                </header>
                                    ...
                                    <asp:Panel ID="pnlIdParametro" runat="server">
                                        <section>
								            <div class="row">
									            ...
									            <div class="col col-9">
										            <label class="input">
                                                        <asp:Label ID="lblIdParametro" runat="server"></asp:Label>
										            </label>
									            </div>
								            </div>
							            </section>
